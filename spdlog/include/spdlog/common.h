...
// clang doesn't like SFINAE disabled constructor in std::is_convertible<> so have to repeat the condition
// from basic_format_string here, in addition, fmt::basic_runtime<Char> is only convertible to
