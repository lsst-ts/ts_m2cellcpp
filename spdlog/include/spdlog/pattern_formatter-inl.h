...
// Full month name
static const std::array<const char *, 12> full_months{{"January", "February", "March", "April", "May", "June",
...
SPDLOG_INLINE void pattern_formatter::handle_flag_(char flag, details::padding_info padding) {
    ...
    switch (flag) {
        ...
        default:  // Unknown flag appears as is
            ...
            // fix issue #1617 (prev char was '!' and should have been treated as funcname flag instead of
            // truncating flag) spdlog::set_pattern("[%10!] %v") => "[      main] some message"
